...
def train_fold(train_folds, val_fold, patience=5):
    # Загружае   CSV
    train_dfs = [pd.read_csv(f"/kaggle/input/datasets/andreikarabin/data10better/aspirantura/PROF/npy_article_fold/train_article_fold_{f}.csv") for f in train_folds]
